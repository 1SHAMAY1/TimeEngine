...
namespace TE {
    ...
    template<>
    struct TEPropertyDrawer<int> {
        static void Draw(void* addr, const std::string& displayName) {
            ImGui::DragInt(displayName.c_str(), (int*)addr);
        }
    };

    template<>
    struct TEPropertyDrawer<bool> {
        static void Draw(void* addr, const std::string& displayName) {
            ImGui::Checkbox(displayName.c_str(), (bool*)addr);
        }
    };

    template<>
    struct TEPropertyDrawer<TEVector2> {
        static void Draw(void* addr, const std::string& displayName) {
    ...
    template<>
    struct TEPropertyDrawer<glm::vec2> {
        static void Draw(void* addr, const std::string& displayName) {
            UIUtils::DrawVec2Control(displayName, *(glm::vec2*)addr);
        }
    };
    ...
    template<>
    struct TEPropertyDrawer<glm::vec3> {
        static void Draw(void* addr, const std::string& displayName) {
    ...
    template<>
    struct TEPropertyDrawer<TEColor> {
        static void Draw(void* addr, const std::string& displayName) {
