...
public:
    ...
    static void SetUniform2f(OpenGLESShader *shader, const TEString &name, const TEVector2 &value);
    static void SetUniform3f(OpenGLESShader *shader, const TEString &name, const TEVector &value);
    static void SetUniform4f(OpenGLESShader *shader, const TEString &name, const TEVector4 &value);
    static void SetUniformMat4(OpenGLESShader *shader, const TEString &name, const TEMatrix4 &value);
    static void SetUniformMat4Array(OpenGLESShader *shader, const TEString &name, const TEArray<TEMatrix4> &values);
