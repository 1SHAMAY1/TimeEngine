...
inline void ExampleBasicColorShader()
{
    ...
    // Set transform
    glm::mat4 transform = ShaderLibrary::CreateModelMatrix(glm::vec3(0.0f, 0.0f, 0.0f), glm::vec3(0.0f, 0.0f, 0.0f),
                                                           glm::vec3(1.0f, 1.0f, 1.0f));
    ShaderLibrary::SetTransform(shader.get(), transform);

    // Set view projection
    glm::mat4 view = ShaderLibrary::CreateViewMatrix(glm::vec3(0.0f, 0.0f, 5.0f), glm::vec3(0.0f, 0.0f, 0.0f));
