...
namespace TE {
    ...
    public:
        ...
        virtual const std::string& GetType() const override { static std::string type = "SpriteSheet"; return type; }
        virtual const std::string& GetName() const override { return m_Name; }
        virtual const std::string& GetHoverDescription() const override { static std::string desc = "Sprite Sheet Asset"; return desc; }
