...
public:
    ...
    static TERef<OpenGLShader> CreateOpenGLBasicShader();
    static TERef<OpenGLShader> CreateOpenGLTextureShader();
    static TERef<OpenGLShader> CreateOpenGLColorShader();
    static TERef<OpenGLShader> CreateOpenGLStandardShader();
    static TERef<OpenGLShader> CreateOpenGLLightingShader();
    static TERef<OpenGLShader> CreateOpenGLParticleShader();
    static TERef<OpenGLShader> CreateOpenGLPostProcessShader();
    static TERef<OpenGLShader> CreateOpenGLUIShader();
    static TERef<OpenGLShader> CreateOpenGLLight2DShader();
    static TERef<OpenGLShader> CreateOpenGLComputeShader(const TEString &computeSource);
    ...
    static void SetDrawBuffers(const TEArray<GLenum> &attachments);
    ...
    static void BindUniformBlock(OpenGLShader *shader, const TEString &blockName, unsigned int bindingPoint);
