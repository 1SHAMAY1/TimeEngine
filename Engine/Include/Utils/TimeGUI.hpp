...
namespace TimeGUI
{
    ...
    enum TimeGUIWindowFlags_
    {
        ...
        TimeGUIWindowFlags_NoDecoration           = TimeGUIWindowFlags_NoTitleBar | TimeGUIWindowFlags_NoResize | TimeGUIWindowFlags_NoScrollbar | TimeGUIWindowFlags_NoCollapse,
        TimeGUIWindowFlags_NoInputs               = TimeGUIWindowFlags_NoMouseInputs | TimeGUIWindowFlags_NoNavInputs | TimeGUIWindowFlags_NoNavFocus,
    };
    ...
    enum TimeGUIHoveredFlags_
    {
        ...
        TimeGUIHoveredFlags_RectOnly                      = TimeGUIHoveredFlags_AllowWhenBlockedByPopup | TimeGUIHoveredFlags_AllowWhenBlockedByActiveItem | TimeGUIHoveredFlags_AllowWhenOverlapped,
    ...
    enum TimeGUIComboFlags_
    {
        ...
        TimeGUIComboFlags_HeightMask_             = TimeGUIComboFlags_HeightSmall | TimeGUIComboFlags_HeightRegular | TimeGUIComboFlags_HeightLarge | TimeGUIComboFlags_HeightLargest,
    };
    ...
    enum TimeGUITreeNodeFlags_
    {
        ...
        TimeGUITreeNodeFlags_CollapsingHeader     = TimeGUITreeNodeFlags_Framed | TimeGUITreeNodeFlags_NoTreePushOnOpen | TimeGUITreeNodeFlags_NoAutoOpenOnLog,
    };
    ...
    struct TE_API TimeGUIDrawList
    {
        ...
        void AddText(const TimeGUIFont &font, float fontSize, const TEVector2 &pos, unsigned int color, const std::string &text);
        void AddRect(const TEVector2 &p1, const TEVector2 &p2, unsigned int color, float rounding = 0.0f, int flags = 0, float thickness = 1.0f);
        ...
        void AddBezierCubic(const TEVector2 &p1, const TEVector2 &p2, const TEVector2 &p3, const TEVector2 &p4, unsigned int color, float thickness, int num_segments = 0);
        void AddCallback(void (*callback)(TimeGUIDrawList parent_list, const void* cmd), void* callback_data);
        void AddDrawCmd();
        void PushClipRect(const TEVector2 &clip_rect_min, const TEVector2 &clip_rect_max, bool intersect_with_current_clip_rect = false);
        void PopClipRect();
        void PushTextureID(TimeGUITextureID texture_id);
        void ResetForNewFrame();

        void AddCircle(const TEVector2 &center, float radius, unsigned int color, int num_segments = 0, float thickness = 1.0f);
        void AddCircleFilled(const TEVector2 &center, float radius, unsigned int color, int num_segments = 0);
        void AddQuadFilled(const TEVector2 &p1, const TEVector2 &p2, const TEVector2 &p3, const TEVector2 &p4, unsigned int color);
        void AddImage(TimeGUITextureID user_texture_id, const TEVector2 &p_min, const TEVector2 &p_max, const TEVector2 &uv_min = {0,0}, const TEVector2 &uv_max = {1,1}, unsigned int col = 0xFFFFFFFF);
        ...
        template<typename T>
        T* As() const { return static_cast<T*>(nativeDrawList); }
    ...
    TE_API void End();
    TE_API bool BeginChild(const std::string &strId, const TEVector2 &size = {0,0}, bool border = false, TimeGUIWindowFlags flags = 0);
    ...
    TE_API void EndMenu();
    TE_API bool MenuItem(const std::string &label, const std::string &shortcut = "", bool selected = false, bool enabled = true);
    ...
    TE_API bool DragFloat(const std::string &label, float *value, float speed = 1.0f, float min = 0.0f, float max = 0.0f, const std::string &format = "%.3f", int flags = 0);
    TE_API bool DragFloat2(const std::string &label, float *v, float speed = 1.0f, float min = 0.0f, float max = 0.0f, const std::string &format = "%.3f", int flags = 0);
    TE_API bool DragFloat3(const std::string &label, float *v, float speed = 1.0f, float min = 0.0f, float max = 0.0f, const std::string &format = "%.3f", int flags = 0);
    TE_API bool DragFloat4(const std::string &label, float *v, float speed = 1.0f, float min = 0.0f, float max = 0.0f, const std::string &format = "%.3f", int flags = 0);
    ...
    TE_API bool SliderFloat(const std::string &label, float *v, float v_min, float v_max, const std::string &format = "%.3f", int flags = 0);
    TE_API bool SliderInt(const std::string &label, int *v, int v_min, int v_max, const std::string &format = "%d", int flags = 0);
    ...
    TE_API bool Combo(const std::string &label, int *currentItem, const char* const items[], int itemsCount, int popupMaxHeightInItems = -1);
    ...
    TE_API bool InputTextMultiline(const std::string &label, char *buf, size_t bufSize, const TEVector2 &size = {0,0}, int flags = 0);
    ...
    TE_API void Image(TimeGUITextureID userTextureId, const TEVector2 &size, const TEVector2 &uv0 = {0,0}, const TEVector2 &uv1 = {1,1});
    TE_API bool ImageButton(const std::string &strId, TimeGUITextureID userTextureId, const TEVector2 &size, const TEVector2 &uv0 = {0,0}, const TEVector2 &uv1 = {1,1});
    ...
    // Table operations
    TE_API bool BeginTable(const std::string &strId, int column, int flags = 0, const TEVector2 &outerSize = {0,0}, float innerWidth = 0.0f);
    TE_API void EndTable();
    TE_API void TableSetupColumn(const std::string &label, int flags = 0, float initWidthOrWeight = 0.0f, unsigned int userId = 0);
    ...
    TE_API unsigned int DockBuilderSplitNode(unsigned int nodeId, int splitDir, float sizeRatio, unsigned int *outIdDir1, unsigned int *outIdDir2);
    ...
    TE_API bool DrawVec3Control(const std::string &label, TEVector &values, float resetValue = 0.0f, float columnWidth = 100.0f);
    TE_API bool DrawVec2Control(const std::string &label, TEVector2 &values, float resetValue = 0.0f, float columnWidth = 100.0f);
    TE_API bool DrawVec4Control(const std::string &label, TEVector4 &values, float resetValue = 0.0f, float columnWidth = 100.0f);
