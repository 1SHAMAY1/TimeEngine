...
void VulkanShaderLibrary::AttachRenderbuffer(unsigned int framebufferID, unsigned int renderbufferID,
                                             uint32_t attachment)
{
}
...
void VulkanShaderLibrary::DispatchCompute(unsigned int shaderID, unsigned int numGroupsX, unsigned int numGroupsY,
                                          unsigned int numGroupsZ)
{
}
void VulkanShaderLibrary::MemoryBarrier(uint32_t barriers) {}
void VulkanShaderLibrary::BindImageTexture(unsigned int unit, unsigned int textureID, int level, bool layered,
...
void VulkanShaderLibrary::SetVertexAttribPointer(unsigned int index, int size, uint32_t type, bool normalized,
