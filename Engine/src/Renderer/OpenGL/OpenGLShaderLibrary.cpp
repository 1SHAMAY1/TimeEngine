...
void OpenGLShaderLibrary::EnableBlending() { glEnable(GL_BLEND); }

void OpenGLShaderLibrary::DisableBlending() { glDisable(GL_BLEND); }

void OpenGLShaderLibrary::SetBlendFunc(GLenum srcFactor, GLenum dstFactor) { glBlendFunc(srcFactor, dstFactor); }

void OpenGLShaderLibrary::EnableDepthTest() { glEnable(GL_DEPTH_TEST); }

void OpenGLShaderLibrary::DisableDepthTest() { glDisable(GL_DEPTH_TEST); }

void OpenGLShaderLibrary::SetDepthFunc(GLenum func) { glDepthFunc(func); }

void OpenGLShaderLibrary::EnableStencilTest() { glEnable(GL_STENCIL_TEST); }

void OpenGLShaderLibrary::DisableStencilTest() { glDisable(GL_STENCIL_TEST); }

void OpenGLShaderLibrary::SetStencilFunc(GLenum func, int ref, unsigned int mask) { glStencilFunc(func, ref, mask); }
...
void OpenGLShaderLibrary::EnableCullFace() { glEnable(GL_CULL_FACE); }

void OpenGLShaderLibrary::DisableCullFace() { glDisable(GL_CULL_FACE); }

void OpenGLShaderLibrary::SetCullFace(GLenum face) { glCullFace(face); }

void OpenGLShaderLibrary::SetFrontFace(GLenum mode) { glFrontFace(mode); }
...
void OpenGLShaderLibrary::DeleteFramebuffer(unsigned int framebufferID) { glDeleteFramebuffers(1, &framebufferID); }

// ===== OpenGL Compute Shader Functions =====
void OpenGLShaderLibrary::DispatchCompute(unsigned int shaderID, unsigned int numGroupsX, unsigned int numGroupsY,
...
void OpenGLShaderLibrary::MemoryBarrier(GLenum barriers) { glMemoryBarrier(barriers); }

void OpenGLShaderLibrary::BindImageTexture(unsigned int unit, unsigned int textureID, int level, bool layered,
                                           int layer, GLenum access, GLenum format)
{
...
void OpenGLShaderLibrary::SetVertexAttribPointer(unsigned int index, int size, GLenum type, bool normalized, int stride,
                                                 const void *pointer)
{
    glVertexAttribPointer(index, size, type, normalized, stride, pointer);
}

void OpenGLShaderLibrary::EnableVertexAttribArray(unsigned int index) { glEnableVertexAttribArray(index); }

void OpenGLShaderLibrary::DisableVertexAttribArray(unsigned int index) { glDisableVertexAttribArray(index); }
...
void OpenGLShaderLibrary::BeginQuery(GLenum target, unsigned int id) { glBeginQuery(target, id); }

void OpenGLShaderLibrary::EndQuery(GLenum target) { glEndQuery(target); }
...
void OpenGLShaderLibrary::FenceSync(GLenum condition, GLbitfield flags) { glFenceSync(condition, flags); }
...
void OpenGLShaderLibrary::DeleteSync(void *sync) { glDeleteSync((GLsync)sync); }
