...
void ShaderLibrary::SetColor(Shader *shader, const TEColor &color) { SetColor(shader, reinterpret_cast<const glm::vec4&>(color.GetValue())); }
...
void ShaderLibrary::SetLightColor(Shader *shader, const TEColor &color)
{
    ...
    {
        OpenGLShader *glShader = dynamic_cast<OpenGLShader *>(shader);
        OpenGLShaderLibrary::SetUniform4f(glShader, "u_LightColor", reinterpret_cast<const glm::vec4&>(color.GetValue()));
    }
}
...
void ShaderLibrary::SetFog(Shader *shader, const TEColor &color, float density, float start, float end)
{
    ...
    {
        OpenGLShader *glShader = dynamic_cast<OpenGLShader *>(shader);
        OpenGLShaderLibrary::SetUniform4f(glShader, "u_FogColor", reinterpret_cast<const glm::vec4&>(color.GetValue()));
                                ...
                                float shininess)
{
    ...
    {
        OpenGLShader *glShader = dynamic_cast<OpenGLShader *>(shader);
        OpenGLShaderLibrary::SetUniform4f(glShader, "u_Material.ambient", reinterpret_cast<const glm::vec4&>(ambient.GetValue()));
        OpenGLShaderLibrary::SetUniform4f(glShader, "u_Material.diffuse", reinterpret_cast<const glm::vec4&>(diffuse.GetValue()));
        OpenGLShaderLibrary::SetUniform4f(glShader, "u_Material.specular", reinterpret_cast<const glm::vec4&>(specular.GetValue()));
...
void ShaderLibrary::SetEmissive(Shader *shader, const TEColor &emissive)
{
    ...
    {
        OpenGLShader *glShader = dynamic_cast<OpenGLShader *>(shader);
        OpenGLShaderLibrary::SetUniform4f(glShader, "u_Emissive", reinterpret_cast<const glm::vec4&>(emissive.GetValue()));
    }
}
...
void ShaderLibrary::SetParticleColor(Shader *shader, const TEColor &startColor, const TEColor &endColor)
{
    ...
    {
        OpenGLShader *glShader = dynamic_cast<OpenGLShader *>(shader);
        OpenGLShaderLibrary::SetUniform4f(glShader, "u_ParticleStartColor", reinterpret_cast<const glm::vec4&>(startColor.GetValue()));
        OpenGLShaderLibrary::SetUniform4f(glShader, "u_ParticleEndColor", reinterpret_cast<const glm::vec4&>(endColor.GetValue()));
    }
}
