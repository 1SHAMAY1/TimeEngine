...
OpenGLESIndexBuffer::~OpenGLESIndexBuffer() { glDeleteBuffers(1, &m_RendererID); }

void OpenGLESIndexBuffer::Bind() const { glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, m_RendererID); }

void OpenGLESIndexBuffer::Unbind() const { glBindBuffer(GL_ELEMENT_ARRAY_BUFFER, 0); }
