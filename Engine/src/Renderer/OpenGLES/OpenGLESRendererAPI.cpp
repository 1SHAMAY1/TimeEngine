...
namespace TE {
    ...
    void OpenGLESRendererAPI::GetViewport(int* viewport) {
        glGetIntegerv(GL_VIEWPORT, viewport);
    }

    void OpenGLESRendererAPI::GetClearColor(float* color) {
    ...
    void OpenGLESRendererAPI::SetBlendFuncSeparate(BlendFactor srcRGB, BlendFactor dstRGB,
                                                    BlendFactor srcAlpha, BlendFactor dstAlpha) {
        glBlendFuncSeparate(GetGLESBlendFactor(srcRGB),   GetGLESBlendFactor(dstRGB),
                            GetGLESBlendFactor(srcAlpha), GetGLESBlendFactor(dstAlpha));
    }
