...
void EngineSettingsButtonLayer::OnUpdate() { m_EngineSettingsLayer->OnUpdate(); }
...
void EngineSettingsButtonLayer::OnEvent(Event &event) { m_EngineSettingsLayer->OnEvent(event); }
