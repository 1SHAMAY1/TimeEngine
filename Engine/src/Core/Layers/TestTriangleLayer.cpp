...
TestTriangleLayer::TestTriangleLayer() { TE_CORE_INFO("TestTriangleLayer: Constructor called."); }

TestTriangleLayer::~TestTriangleLayer() { TE_CORE_INFO("TestTriangleLayer: Destructor called."); }
