...
CameraLayer::CameraLayer() { TE_CORE_INFO("CameraLayer: Constructor called."); }

CameraLayer::~CameraLayer() { TE_CORE_INFO("CameraLayer: Destructor called."); }
...
void CameraLayer::OnDetach() { TE_CORE_INFO("CameraLayer: OnDetach called."); }
...
void CameraLayer::HandleInput(float deltaTime)
{
    ...
    if (m_WPressed)
    {
        ...
        TE_CORE_INFO("W key pressed - moving up. New position: ({0}, {1}, {2})", m_CameraPosition.x, m_CameraPosition.y,
                     m_CameraPosition.z);
    }
    ...
    {
        m_CameraPosition.y -= m_MovementSpeed * deltaTime;
        TE_CORE_INFO("S key pressed - moving down. New position: ({0}, {1}, {2})", m_CameraPosition.x,
    ...
    if (m_APressed)
    {
        ...
        TE_CORE_INFO("A key pressed - moving left. New position: ({0}, {1}, {2})", m_CameraPosition.x,
                     m_CameraPosition.y, m_CameraPosition.z);
    }
    ...
    {
        m_CameraPosition.x += m_MovementSpeed * deltaTime;
        TE_CORE_INFO("D key pressed - moving right. New position: ({0}, {1}, {2})", m_CameraPosition.x,
                     m_CameraPosition.y, m_CameraPosition.z);
    }
