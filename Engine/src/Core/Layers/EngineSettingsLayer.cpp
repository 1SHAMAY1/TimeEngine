...
EngineSettingsLayer::~EngineSettingsLayer() { TE_CORE_INFO("EngineSettingsLayer destroyed"); }
...
void EngineSettingsLayer::OnDetach() { TE_CORE_INFO("EngineSettingsLayer detached"); }
...
void EngineSettingsLayer::RenderDebugTab()
{
    ...
    TimeGUI::Text("  Show Performance Metrics: %s",
                  m_Settings.IsShowPerformanceMetricsEnabled() ? "Enabled" : "Disabled");
...
void EngineSettingsLayer::RenderRenderingTab()
{
    ...
    TimeGUI::Text("Current Settings:");
    const float *clearColor = m_Settings.GetClearColor();
    TimeGUI::Text("  Clear Color: (%.2f, %.2f, %.2f, %.2f)", clearColor[0], clearColor[1], clearColor[2],
                  clearColor[3]);
...
void EngineSettingsLayer::ApplyCurrentSettings()
{
    ...
    m_Settings.SetClearColor(m_TempSettings.clearColor[0], m_TempSettings.clearColor[1], m_TempSettings.clearColor[2],
                             m_TempSettings.clearColor[3]);
