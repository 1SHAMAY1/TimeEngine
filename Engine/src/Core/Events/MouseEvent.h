...
public:
    ...
    {
        return TEString("MouseMovedEvent: ") + TEString::FromFloat(m_MouseX, 2) + ", " +
               TEString::FromFloat(m_MouseY, 2);
    }
...
public:
    ...
    TEString ToString() const override
    {
        return TEString("MouseScrolledEvent: ") + TEString::FromFloat(m_XOffset, 2) + ", " +
               TEString::FromFloat(m_YOffset, 2);
    }
