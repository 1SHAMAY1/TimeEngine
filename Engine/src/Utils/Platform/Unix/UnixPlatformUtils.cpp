...
namespace TE
{
std::string PlatformUtils::OpenFolder(const char *initialPath) { return ""; }

std::string PlatformUtils::OpenFile(const char *filter) { return ""; }

std::string PlatformUtils::SaveFile(const char *filter) { return ""; }
