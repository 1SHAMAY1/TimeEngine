...
public:
    ...
    // Decentralized Import Dialog
    static TERef<AssetEditor> GetEditorForImportExtension(const TEString &sourceExt);
    static TEString BuildImportFileDialogFilter();
    static void OpenImportDialog(const TEString &targetDirectory, const TEString &sourceFilePath = "");
