...
void SceneHierarchyPanel::OnTimeGUIRender(Ref<EditorLayer> editor)
{
    ...
    // Drop on empty hierarchy window area moves entity to scene root
                                         ...
                                         Entity &entityToDelete)
{
    ...
    DragDropManager::BeginSourceEntity((uint64_t)entityID, entityName);
    DragDropManager::ExecuteTarget(DragDropTargetContext::SceneHierarchy, (void *)(uintptr_t)entityID, editor);
