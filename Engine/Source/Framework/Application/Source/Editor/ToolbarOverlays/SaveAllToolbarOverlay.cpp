...
void SaveAllToolbarOverlay::OnCustomRender(const TEString &itemId, Ref<EditorLayer> editor)
{
    ...
    if (hasDirty)
    {
        TimeGUI::PushStyleColor(TimeGUICol_Button, TEVector4(0.18f, 0.20f, 0.25f, 0.95f));
        TimeGUI::PushStyleColor(TimeGUICol_ButtonHovered, TEVector4(0.25f, 0.28f, 0.34f, 1.0f));
    }
    else
    {
        TimeGUI::PushStyleColor(TimeGUICol_Button, TEVector4(0.13f, 0.15f, 0.18f, 0.90f));
        TimeGUI::PushStyleColor(TimeGUICol_ButtonHovered, TEVector4(0.19f, 0.22f, 0.27f, 1.0f));
    }
