...
public:
    ...
    T_PROPERTY(TEString, SpriteSheetPath, "Sprite Sheet Path", "")
    T_PROPERTY(AssetHandle, SpriteSheetHandle, "Sprite Sheet", 0)
...
T_REGISTER_PROPERTY(AnimatedSpriteComponent, TEString, SpriteSheetPath, "Sprite Sheet Path")
T_REGISTER_PROPERTY(AnimatedSpriteComponent, AssetHandle, SpriteSheetHandle, "Sprite Sheet")
T_REGISTER_PROPERTY(AnimatedSpriteComponent, TEColor, Color, "Color")
