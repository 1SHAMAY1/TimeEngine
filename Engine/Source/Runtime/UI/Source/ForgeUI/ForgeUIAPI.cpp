...
bool ForgeUIAPI::BeginDragDropTarget() { return false; }
const TimeGUIPayload *ForgeUIAPI::AcceptDragDropPayload(const TEString &type, int flags) { return nullptr; }
...
float ForgeUIAPI::GetScrollMaxY() { return 0.0f; }
