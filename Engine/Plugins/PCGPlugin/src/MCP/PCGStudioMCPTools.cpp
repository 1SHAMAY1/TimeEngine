...
// 2. pcg_execute_graph
TE_REGISTER_MCP_TOOL(pcg_execute_graph, "Execute a PCG graph file from disk and return generated point count metrics.",
                     "{\"type\":\"object\",\"properties\":{\"path\":{\"type\":\"string\"},\"seed\":{\"type\":"
