...
TE_REGISTER_MCP_TOOL(
    tts_speak,
    "Synthesize and speak text locally with optional sync/async mode, voice, pitch, rate, and acoustic rich text "
    "markup.",
    "{\"type\":\"object\",\"properties\":{\"text\":{\"type\":\"string\"},\"mode\":{\"type\":\"string\",\"enum\":["
    "\"async\",\"sync\"]},\"voice\":{\"type\":\"string\"},\"pitch\":{\"type\":\"number\"},\"rate\":{\"type\":"
    "\"number\"},\"volume\":{\"type\":\"number\"},\"interrupt\":{\"type\":\"boolean\"}},\"required\":[\"text\"]}",
...
// 2. tts_stop
TE_REGISTER_MCP_TOOL(tts_stop, "Stop all active and queued speech playback immediately.",
...
// 3. tts_list_voices
TE_REGISTER_MCP_TOOL(tts_list_voices, "List all available local TTS voices installed on the system.",
                     "{\"type\":\"object\",\"properties\":{}}",
                     [](const TEString &paramsJson) -> TEString
                     {
...
// 4. tts_set_voice
TE_REGISTER_MCP_TOOL(tts_set_voice, "Set the active TTS voice by name.",
...
// 5. tts_get_status
TE_REGISTER_MCP_TOOL(tts_get_status, "Get TTS audio engine status, is_speaking state, and pending queue count.",
                     "{\"type\":\"object\",\"properties\":{}}",
                     [](const TEString &paramsJson) -> TEString
                     {
