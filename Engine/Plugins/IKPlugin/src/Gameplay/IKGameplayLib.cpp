...
bool IKGameplayLib::SolveTwoBone2D(const TEVector2& root, float lenA, float lenB, const TEVector2& target, bool bendPos, TEVector2& outMid, float& outAngleA, float& outAngleB)
{
