...
TE_REGISTER_MCP_TOOL(
    ...
    "{\"type\":\"object\",\"properties\":{\"json_path\":{\"type\":\"string\"},\"output_path\":{\"type\":\"string\"}},\"required\":[\"json_path\"]}",
...
TE_REGISTER_MCP_TOOL(
    ...
    "{\"type\":\"object\",\"properties\":{\"name\":{\"type\":\"string\"},\"output_path\":{\"type\":\"string\"}},\"required\":[\"output_path\"]}",
    [](const TEString &paramsJson) -> TEString {
        TEString jsonStr = paramsJson;
