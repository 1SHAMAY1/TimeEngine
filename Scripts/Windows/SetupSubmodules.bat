...
set "PREMAKE_DIR=%~dp0\..\..\Vendor\Premake\Windows"
...
if not exist "%PREMAKE_EXE%" (
    ...
    powershell -Command "Invoke-WebRequest -Uri 'https://github.com/premake/premake-core/releases/download/v5.0.0-beta2/premake-5.0.0-beta2-windows.zip' -OutFile '%PREMAKE_DIR%\premake.zip'"
